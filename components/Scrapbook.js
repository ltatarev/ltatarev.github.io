        ...
        <div className="phone">
          <div className="screen">
            ...
            <div className="scr-tab">
              ...
              <svg viewBox="0 0 24 24" fill="none">
                <rect x="4" y="4" width="6" height="6" rx="1.6" stroke="#bdb7ab" strokeWidth="2" />
                <rect x="14" y="4" width="6" height="6" rx="1.6" stroke="#bdb7ab" strokeWidth="2" />
                <rect x="4" y="14" width="6" height="6" rx="1.6" stroke="#bdb7ab" strokeWidth="2" />
                <rect
                  x="14"
                  y="14"
                  width="6"
